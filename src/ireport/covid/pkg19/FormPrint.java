...
public class FormPrint extends javax.swing.JFrame {
    ...
    public void loadStatus(){
        ...
        try{
            ...
            String sql = "SELECT DISTINCT status_kasus as sts from pasien";
            ResultSet rs = stm.executeQuery(sql);
            jComboBox1.addItem("Pilih Berdasarkan Kasus");
            while(rs.next()){
                jComboBox1.addItem(rs.getString("sts"));
            }
            rs.close();
            stm.close();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jComboBox1.getSelectedIndex() == 0 ) {
            JOptionPane.showMessageDialog(rootPane, "Pilih Kasus TerlebihDahulu");
        }else{
            try{
                String filePath = "src\\report\\ReportByKasus.jrxml";
                Connection con = Koneksi.koneksiDB();
                HashMap param = new HashMap();
                param.put("kasus", jComboBox1.getSelectedItem().toString());
                JasperReport jrpt = JasperCompileManager.compileReport(filePath);
